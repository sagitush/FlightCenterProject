...
namespace FlightWebApplication.Controllers
{
    ...
    public class AdministratorFacadeController : ApiController
    {
        ...
        public LoginToken<Administrator> GetAdminLoginToken()
        {
        ...
        public IHttpActionResult CreateNewAirline([FromBody]AirlineCompany airlineCompany)
        {
            ...
            {
                GetAdminFacade().CreateNewAirline(GetAdminLoginToken(), airlineCompany);
                return Ok();
            }
        }
        ...
        {           
            if (customer == null)
                return BadRequest(ModelState);
            GetAdminFacade().CreateNewCustomer(GetAdminLoginToken(), customer);
            return Ok();
        ...
        public IHttpActionResult UpdateAirlineDetails([FromBody]AirlineCompany airline, [FromUri]long id)
        {
            ...
            {
                airline.Id = id;
                GetAdminFacade().UpdateAirlineDetails(GetAdminLoginToken(), airline);
                return Ok();
            }
        }
        ...
        public IHttpActionResult UpdateCustomerDetails([FromBody]Customer customer, [FromUri]long id)
        {
            ...
            {
                customer.Id = id;
                GetAdminFacade().UpdateCustomerDetails(GetAdminLoginToken(), customer);
                return Ok();
            }           
        }
        ...
        public IHttpActionResult RemoveAirline(long companyId)
        {
            ...
            if (airline == null)
                return BadRequest(ModelState);
            GetAdminFacade().RemoveAirline(GetAdminLoginToken(), airline);
            return Ok();
        }
        ...
        public IHttpActionResult RemoveCustomer(long customerId)
        {
            ...
            if (customer == null)
                return BadRequest(ModelState);
            GetAdminFacade().RemoveCustomer(GetAdminLoginToken(), customer);
            return Ok();
        }
    }
}
